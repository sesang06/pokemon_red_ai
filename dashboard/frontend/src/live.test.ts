...
const state = {
  ...
  agent: { phase: "not_started", objective: null, task: null, action: null, result: null, pipeline: {}, planner_calls: 0, executor_actions: 0, interpreter_calls: 0, plan_error: null, interpret_error: null },
